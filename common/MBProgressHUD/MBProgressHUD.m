...
@synthesize customString ; //Add by wy 
...
+ (BOOL)hideHUDForView:(UIView *)view animated:(BOOL)animated
{
    ...
    for (MBProgressHUD *HUD in viewsToRemove)
    {
...
- (void)showWhileExecuting:(SEL)method onTarget:(id)target withObject:(id)object animated:(BOOL)animated {
    ...
    //[self otsDetatchMemorySafeNewThreadSelector:@selector(launchExecution) toTarget:self withObject:nil];
